        ...
        <div className="max-w-screen-md mx-auto px-4 md:px-6 text-center reveal">
          ...
          <form className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto">
            <input
              ...
              className="flex-1 bg-neutral-800 border border-neutral-700 text-white text-sm rounded-xl px-4 py-3 outline-none focus:border-[var(--primary)] transition-colors placeholder:text-neutral-500"
            />
            <button
              type="submit"
              className="bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white text-sm font-bold px-6 py-3 rounded-xl transition-colors"
            >
              Subscribe
            </button>
          </form>
