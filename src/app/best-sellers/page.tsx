...
export const metadata: Metadata = {
  title: "Best Sellers | Anashe",
  description: "Most-loved skincare picks trusted by our community.",
};

export default async function BestSellersPage() {
  const products = await getProductsBySegment("best-sellers");
    ...
    <>
      ...
      <main className="pt-16">
        <section className="max-w-[1440px] mx-auto px-6 pt-14 pb-10 border-b border-neutral-100">
          <h1 className="text-4xl lg:text-5xl font-medium tracking-tighter">Best Sellers</h1>
          <p className="text-sm text-neutral-500 mt-3 max-w-xl">Tried, trusted, and repurchased skincare essentials.</p>
        </section>
